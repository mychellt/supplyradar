...
import br.com.supplyradar.persistence.mapper.CycleAvoidingMappingJpaContext;
...
public class EnderecoRepositoryAdapter implements EnderecoRepository {
    ...
    public Endereco save(Endereco endereco) {
        CycleAvoidingMappingJpaContext context = new CycleAvoidingMappingJpaContext();
        return mapper.mapFrom(jpa.save(mapper.mapFrom(endereco, context)), new CycleAvoidingMappingJpaContext());
    }
}
